...
<body>
  ...
  <form class="form form--add-lot container <?= $classname; ?> " action="add.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form__container-two">
      ...
      <div class="form__item <?=$classname;?>">
        ...
        <select id="category" name="category" required>
          ...
          <?php foreach ($categories as $category): ?>
          <option><?= htmlspecialchars($category['category_name']) ?></option>
          <?php endforeach ?>
        </select>
   ...
   <?php $classname = isset($errors['img-file']) ? "form__item--invalid" : ""; ?> 
    <div class="form__item form__item--file <?=$classname;?>">
      ...
      <div class="form__input-file">
        <input class="visually-hidden" name="img-file" type="file" id="photo2" value="">
        <label for="photo2">
          <span>+ Добавить</span>
        </label>
      </div>
