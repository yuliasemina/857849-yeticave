...
(floor((strtotime('now')-strtotime(htmlspecialchars($bet['time'])))/'60')) .' '.
            nounEnding(floor((strtotime('now')-strtotime(htmlspecialchars($bet['time'])))/'60'), ["минута назад", "минуты назад", "минут назад"]) ?></td>
...
(floor((strtotime('now')-strtotime(htmlspecialchars($bet['time'])))/'3600')) .' '.
            nounEnding(floor((strtotime('now')-strtotime(htmlspecialchars($bet['time'])))/'3600'), ["час назад", "часа назад", "часов назад"]) ?></td>
<?php else: ?>
